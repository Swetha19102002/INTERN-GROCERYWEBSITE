const products = [
    ...
    { id: 4, name: 'CAULIFLOWER 1kg',category:'Vegetables', price: 25, image: '/static/images/4.png' },
    { id: 5, name: 'PUMPKIN 1kg',category:'Vegetables', price: 30, image: '/static/images/5.png' },
    { id: 6, name: 'SUNFLOWER OIL 1kg', category:'Oil',price: 180, image: '/static/images/6.png' },
    { id: 7, name: 'COCACOLA 1liter',category:'Snacks', price: 45, image: '/static/images/7.png' },
    { id: 8, name: 'Doughnut 1kg',category:'Snacks', price: 80, image: '/static/images/8.png' },
    { id: 9, name: 'RUSK 1', category:'Snacks',price: 35, image: '/static/images/9.png' },
    { id: 10, name: 'APPLE 1kg',category:'Fruits', price: 110, image: '/static/images/10.png' },
     { id: 11, name: 'FROOTI 500ML',category:'Snacks', price: 25, image: '/static/images/11.png' },
    { id: 12, name: 'SPRITE 1L',category:'Snacks', price: 40, image: '/static/images/12.png' },
    { id: 13, name: 'MANGO 1kg',category:'Fruits', price: 60, image: '/static/images/13.png' },
    { id: 14, name: 'BANANA 1kg',category:'Fruits', price: 35, image: '/static/images/14.png' },
    { id: 15, name: 'BROCCOLI 1kg',category:'Vegetables', price: 35, image: '/static/images/15.png' },
    { id: 15, name: 'SPINACH 1',category:'Vegetables', price: 20, image: '/static/images/16.png' },
    ...
    { id: 19, name: 'MOSAMBI 1kg',category:'Fruits', price: 55, image: '/static/images/19.png' },
    { id: 20, name: 'CUPCAKES 1kg',category:'Snacks', price: 70, image: '/static/images/20.png' },
    { id: 21, name: 'MIRANDA 1L',category:'Snacks', price: 40, image: '/static/images/21.png' },
    { id: 22, name: 'PEDIGREE 1kg', category:'products',price: 150, image: '/static/images/22.png'},
    { id: 23, name: 'VIM LIQUID 1liter', category:'products',price: 120, image: '/static/images/23.png' },
    { id: 24, name: 'ODONIL 1', price: 30,category:'products', image: '/static/images/24.png' },
    { id: 25, name: 'NOODELS 1',category:'Snacks', price: 40, image: '/static/images/25.png' }
